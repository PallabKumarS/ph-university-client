...
const OfferCourse = () => {
  ...
  const { data: academicTeacherData } = useGetAcademicFacultiesQuery(undefined);
  ...
  const academicTeacherOptions = academicTeacherData?.data?.map((item) => ({
    value: item._id,
    label: item.name,
  }));
      ...
      <Col span={6}>
        <PHForm onSubmit={onSubmit}>
          ...
          <PHSelect
            ...
            options={academicTeacherOptions}
          />
          <PHSelect
